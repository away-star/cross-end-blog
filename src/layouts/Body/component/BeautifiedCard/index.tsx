        ...
        <>
            <div className={classNames(styles.card)}>
                ...
                <div className={classNames(styles.content)}>
                    ...
                    <div className={classNames(styles.item, styles["item--post"])}>
                        <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div className={classNames(styles.item, styles["item--inspire"])}>
                        <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <button className={styles.btn} type={'button'}>Write to Infinity!</button>
            </div>
        </>
    );
};
