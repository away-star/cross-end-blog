        ...
        <div className="content">
            <div className="card">
                <div className="card-info">
                    ...
                    <div className="card-title">小星</div>
                    <div className="card-subtitle">专注于前端开发的后端工程师</div>
                    <p className="text-body">So far all life is written with failure, but this does not prevent me from
                        moving forward</p>
                </div>
